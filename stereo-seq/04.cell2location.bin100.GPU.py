...
count_data_file = sys.argv[3]
sample_id = sys.argv[4]

results_folder = f'/xdisk/mliang1/qqiu/project/multiomics-hypertension/cell2location/{sample_id}'
ref_run_name = '/xdisk/mliang1/qqiu/project/multiomics-hypertension/cell2location/reference_signatures/rat.ss.LK'
...
adata_file = f"{ref_run_name}/sn.h5ad"
...
adata_sp.obsm['means_cell_abundance_w_sf'].to_csv(f"{results_folder}/cell2location.means_cell_abundance_w_sf.csv")
adata_sp.obsm['stds_cell_abundance_w_sf'].to_csv(f"{results_folder}/cell2location.stds_cell_abundance_w_sf.csv")
adata_sp.obsm['q05_cell_abundance_w_sf'].to_csv(f"{results_folder}/cell2location.q05_cell_abundance_w_sf.csv")
adata_sp.obsm['q95_cell_abundance_w_sf'].to_csv(f"{results_folder}/cell2location.q95_cell_abundance_w_sf.csv")
